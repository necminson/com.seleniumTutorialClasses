...
public class WebElements03 {
 ...
 /*
        ...
        List<WebElement> webElementListesi = driver.findElements(By.tagName("button"));
        int numOfWebElmnt = webElementListesi.size();
        System.out.println("numOfWebElmnt = " + numOfWebElmnt);
        // 4- sayfadaki herbir button uzerindeki yazilari yazdirin
        for (WebElement w:webElementListesi) {
