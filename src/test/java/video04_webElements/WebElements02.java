...
public class WebElements02 {
    public static void main(String[] args) {
        ...
        String actualData= errorMessage.getText();
        String expectedData ="The email address or mobile number you entered isn't connected to an account. Find your account and log in.";
        ...
        driver.close();
         ...
         /*Ahmet hocanın çözümü // Note: Ahmet hocanın kodları yazıldıktan sonra sanırım Developerlar tarafından  HTML kısmında değişiklik yapılmış.Bende çalışmadı
        // https://www.facebook.com adresine gidin
        driver.get("https:www.facebook.com");
        // cookies cikarsa kabul et butonuna basin
        //driver.findElement(By.xpath("//button[@title='Allow essential and optional cookies']")).click();
